...
void help()
{
    ...
    cout << "   -h          Display this help text" << endl
         << endl;
    cout << "   -a p1;p2;.. Add one or more entries to the resource search path" << endl
         << endl;
    ...
    cout << "               the -c and -s parameters, e.g. -p 0 -c host1;host2;host3,..." << endl
         << endl;
    cout << "   -q          Quiet mode - do not print any log messages to stdout" << endl
         << endl;
    ...
    cout << "                       out -- by default, \"~/mitsuba\" is used)" << endl
         << endl;
    cout << "   -s file     Connect to additional Mitsuba servers specified in a file" << endl;
    cout << "               with one name per line (same format as in -c)" << endl
         << endl;
    cout << "   -n name     Assign a node name to this instance (Default: host name)" << endl
         << endl;
    cout << "   -t          Execute all testcases" << endl
         << endl;
    cout << "   -v          Be more verbose" << endl
         << endl;
    cout << "   -w          Treat warnings as errors" << endl
         << endl;

    FileResolver *fileResolver = Thread::getThread()->getFileResolver();
    std::ostringstream utilities, testcases;

    cout << "[ Loading plugin list .. ]" << endl
         << endl;

    testcases << "The following testcases are available:" << endl
              << endl;
    utilities << endl
              << "The following utilities are available:" << endl
              << endl;
...
#error Unknown operating system!
            ...
            if (!fs::exists(fullName))
            {
                ...
                SLog(EError, "Utility \"%s\" not found (run \"mtsutil\" without arguments to "
                             "see a list of available utilities)",
