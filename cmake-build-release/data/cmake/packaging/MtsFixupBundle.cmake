...
if (APPLE)
  ...
  function (gp_resolve_item_override context item exepath dirs resolved_item_var resolved_var)
    set (dependency_dest "${CMAKE_INSTALL_PREFIX}/.")
  ...
  function (gp_resolved_file_type_override file type_var)
    if ("${${type_var}}" STREQUAL "other")
      set (base_preffix "${CMAKE_INSTALL_PREFIX}/./")
...
file (GLOB_RECURSE QTPLUGINS
  "${CMAKE_INSTALL_PREFIX}/qt4plugins/*${CMAKE_SHARED_LIBRARY_SUFFIX}")
  
# Get the python bindings as well
file (GLOB PYBINDINGS "${CMAKE_INSTALL_PREFIX}/python/*")
...
if (NOT APPLE OR NOT BUILD_GUI)
  get_filename_component(EXEDIR "${CMAKE_INSTALL_PREFIX}/." ABSOLUTE)
